...
Quick commands: `make smoke`, `make p0-verify`, `make dqc-help`. После подъёма стека с хоста: [`scripts/ingress_smoke.sh`](../scripts/ingress_smoke.sh) (портал, Superset/nl2sql health, Prometheus за ingress).
